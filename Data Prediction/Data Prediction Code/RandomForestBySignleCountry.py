...
# 只提取美国的数据
country_data = df[df['country'] == 'JPN'].copy()
country = 'JPN'

# Here change the specified year what you want to predict in that year (Remove the data in that year in advance)
country_data = country_data[~country_data['year'].isin([2020,2024,2028])]
# 创建滞后特征和滑动平均特征
...
print(f"\nMedal prediction for {country} in 2020:")
